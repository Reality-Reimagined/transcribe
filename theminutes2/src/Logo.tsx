...
//           animate={{ rotate: 0, originX: 100, originY: 100 }}
...
//           strokeWidth="4"
//           strokeLinecap="round"
//           initial={{ rotate: -180, originX: 100, originY: 100 }}
//           animate={{ rotate: 0, originX: 100, originY: 100 }}
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Hour hand - slimmer and smoother ticking */}
        <motion.line
          x1="100"
          y1="100"
          x2="100"
          y2="30"
          stroke="#000000"
          strokeWidth="3" // Slimmer hour hand
          strokeLinecap="round"
          initial={{ rotate: 0, originX: 100, originY: 100 }}
          animate={{ rotate: 360 }}
          transition={{
            duration: 12, // 12 seconds for a full rotation
            ease: "linear",
            repeat: Infinity,
          }}
        />
        
        {/* Minute hand - slimmer and smoother ticking */}
        <motion.line
          x1="100"
          y1="100"
          x2="150"
          y2="100"
          stroke="#000000"
          strokeWidth="2" // Slimmer minute hand
          strokeLinecap="round"
          initial={{ rotate: 0, originX: 100, originY: 100 }}
          animate={{ rotate: 360 }}
          transition={{
